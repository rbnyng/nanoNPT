...
uncertainty_dim = 64  # Small latent space for debugging
...
kl_anneal_start = 3000        # Start annealing after model stabilizes
...
# Debug settings
compile = True  # Disable for easier debugging
